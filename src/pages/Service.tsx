...
export default function main(){
    ...
    <div className='text-text-secondary flex flex-row p-10 font-main'>
        <img src={service?.Image} alt="" className='flex-4 rounded-2xl max-w-[45vw]'/>
        <div className='flex-5'>
            ...
            <div>
                ...
                <div className='flex flex-col justify-center px-10 items-center py-2 gap-5'>
                    {thisWorkers?.map((worker: Worker, index)=>{
                        return(<div key={index} className='flex flex-col border border-text-primary p-2 rounded-md justify-center items-center gap-2 w-150 mt-2'>
